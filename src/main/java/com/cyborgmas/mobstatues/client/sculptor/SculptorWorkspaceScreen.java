...
public class SculptorWorkspaceScreen extends AbstractContainerScreen<SculptorWorkspaceMenu> implements RecipeUpdateListener {
    ...
    //mostly copied from crafting screen
    private final SculptorWorkspaceRecipeBookComponent recipeBookComponent = new SculptorWorkspaceRecipeBookComponent();
